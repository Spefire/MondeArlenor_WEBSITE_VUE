...
import CrystalSingleView from "@/views/roleplay/crystal-single/CrystalSingleView.vue";
...
const routes: Array<RouteRecordRaw> = [
  ...
  { path: "/roleplay/crystal", component: CrystalSingleView, meta: { title: PageTitles.crystals }},
