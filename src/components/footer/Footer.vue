  ...
  <footer v-if="displayLarge">
    <div class="footer-infos">
      <div class="footer-left">
        ...
        <div class="footer-container">
          <p>
            Le Monde d'Arlénor est un univers fantastique, créé en 2015 par Nicholas (aka Spefire) pour en faire un Jeu de Rôles.
          </p>
      ...
      <div class="footer-right">
        <FooterLink
          :with-border="true"
          :link="'https://nicholas-brun.fr'"
          :icon-class="'icon-user'" />
        <FooterLink
          :with-border="true"
          :link="'https://www.instagram.com/spefireflies'"
          :icon-class="'icon-instagram'" />
        <FooterLink
          :with-border="true"
          :link="'https://www.github.com/spefire'"
