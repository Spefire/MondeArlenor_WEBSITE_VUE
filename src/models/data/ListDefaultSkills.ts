...
export function getListDefaultSkills(): ArlenorSkill[] {
  ...
  arme01.init(getLibArme("à une main, avec bouclier"), SkillsEnum.CompetenceArme);
  ...
  arme02.init(getLibArme("épées à deux mains"), SkillsEnum.CompetenceArme);
  ...
  arme03.init(getLibArme("mains nues"), SkillsEnum.CompetenceArme);
  ...
  arme04.init(getLibArme("d'hast"), SkillsEnum.CompetenceArme);
  ...
  arme05.init(getLibArme("dagues / armes de jets"), SkillsEnum.CompetenceArme);
  ...
  arme06.init(getLibArme("arcs / arbalètes"), SkillsEnum.CompetenceArme);
  ...
  arme07.init(getLibArme("sabres"), SkillsEnum.CompetenceArme);
  ...
  arme08.init(getLibArme("ambidextrie"), SkillsEnum.CompetenceArme);
  ...
  arme09.init(getLibArme("épées à une main"), SkillsEnum.CompetenceArme);
  ...
  arme10.init(getLibArme("orbes mystiques"), SkillsEnum.CompetenceArme);
  ...
  arme11.init(getLibArme("sceptres à une main"), SkillsEnum.CompetenceArme);
  ...
  arme12.init(getLibArme("bâtons"), SkillsEnum.CompetenceArme);
  ...
  arme13.init(getLibArme("mains nues"), SkillsEnum.CompetenceArme);
  ...
  arme14.init(getLibArme("bâtons"), SkillsEnum.CompetenceArme);
  ...
  arme15.init(getLibArme("bâtons"), SkillsEnum.CompetenceArme);
  arme15.initGrpSpe(groups.Pretre, []);
  arme15.caracts = [CaractNomEnum.Habilete];
  listSkills.push(arme15);

  const arme16 = new ArlenorSkill();
  arme16.init(getLibArme("instruments de musique"), SkillsEnum.CompetenceArme);
...
export function getListRaceSkills(raceCode = ""): ArlenorSkill[] {
  ...
  skill00.init("Polyvalence", SkillsEnum.CompetenceRace);
  ...
  skill10.init("Athlète agile", SkillsEnum.CompetenceRace);
  ...
  skill11.init("Monde des rêves", SkillsEnum.CompetenceRace);
  ...
  skill20.init("Viande crue", SkillsEnum.CompetenceRace);
  ...
  skill21.init("Spécialité secrète de Kazador", SkillsEnum.CompetenceRace);
  ...
  skill30.init("Langage animal", SkillsEnum.CompetenceRace);
  ...
  skill31.init("Partie animale", SkillsEnum.CompetenceRace);
  ...
  skill40.init("Corps jeune", SkillsEnum.CompetenceRace);
  ...
  skill41.init("Innocence", SkillsEnum.CompetenceRace);
  ...
  skill42.init("Végétarien ou Végan", SkillsEnum.CompetenceRace);
  ...
  skill43.init("Peau nuitée", SkillsEnum.CompetenceRace);
  ...
  skill50.init("Tatouages évolutifs", SkillsEnum.CompetenceRace);
  ...
  skill51.init("Haine des races", SkillsEnum.CompetenceRace);
  ...
  skill52.init("Grandeur", SkillsEnum.CompetenceRace);
  ...
  skill53.init("Végétarien ou Végan", SkillsEnum.CompetenceRace);
  ...
  skill60.init("Coeur de cristal", SkillsEnum.CompetenceRace);
  ...
  skill61.init("Esprit familier", SkillsEnum.CompetenceRace);
